...
def detection_box(tools_dect, hand_dect, current_frame, depth_frame, intr):
    ...
    for hand in hand_list:
        ...
        for target in target_pixel:
            ...
            # if target_middle_x > middle_x + DETECT_PADDING: flag_Right = True
            # elif target_middle_x < middle_x - DETECT_PADDING: flag_Left = True
            # if target_middle_y > middle_y + DETECT_PADDING:  flag_Down  = True
            # elif target_middle_y < middle_y - DETECT_PADDING: flag_Up    = True

            # 주의: 카메라는 90도 돌아가 있음
            cam_Up = target_middle_y < middle_y - DETECT_PADDING
            cam_Down = target_middle_y > middle_y + DETECT_PADDING
            cam_Left = target_middle_x < middle_x - DETECT_PADDING
            cam_Right = target_middle_x > middle_x + DETECT_PADDING
