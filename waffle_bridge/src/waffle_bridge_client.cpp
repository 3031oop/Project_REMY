...
private:
  ...
  void rosCallback(const std_msgs::msg::String::SharedPtr msg) {
    ...
    if (msg->data == "detect" || msg->data == "depart" || msg->data == "wait_return" || msg->data == "patrol" || msg->data == "force_return" || msg->data == "return") {
      std::string wire_msg = "[VOI]" + msg->data + "\n";
      ...
      //}
		if (!received_raw.empty()) {
		    ...
		    if (open_bracket != std::string::npos && close_bracket != std::string::npos) {
		        ...
		        if (sender_id == "HSJ_AND" || sender_id == "ADMIN"|| sender_id == "VOI"|| sender_id == "WA") {
		            if (pure_cmd == "tts1") {
		                msg.data = "start";
